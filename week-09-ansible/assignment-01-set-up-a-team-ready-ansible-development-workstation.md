...
![Task 1](<screenshots/week 08-assignment 01-screenshot 1.png>).
...
![Task 2](<screenshots/week 08-assignment 01-screenshot 2.png>).
...
![Task 3.A](<screenshots/week 08-assignment 01-screenshot 3.png>).
...
![Task 3.B](<screenshots/week 08-assignment 01-screenshot 4.png>).
...
![Task 4.A](<screenshots/week 08-assignment 01-screenshot 5.png>).
...
![Task 4.B](<screenshots/week 08-assignment 01-screenshot 6.png>).
...
![Task 5](<screenshots/week 08-assignment 01-screenshot 7.png>).
...
![Task 6](<screenshots/week 08-assignment 01-screenshot 8.png>).
...
![Task 7.A](<screenshots/week 08-assignment 01-screenshot 9.png>).
...
![Task 7.B](<screenshots/week 08-assignment 01-screenshot 10.png>).
...
![Task 8.A](<screenshots/week 08-assignment 01-screenshot 11.png>).
...
![Task 8.B](<screenshots/week 08-assignment 01-screenshot 12.png>).
...
One team-friendly feature is the use of a standardized Python virtual environment and project configuration. This allows team members to use the same isolated Ansible tooling and reduces differences between individual development workstations.

---

**2. What is one pitfall you avoided while completing the setup?**

I avoided installing Ansible globally on the system. I also ensured that sensitive SSH private keys and the local .venv directory were excluded from version control.

---

**3. Why should Ansible be installed inside a Python virtual environment?**

Installing Ansible inside a Python virtual environment isolates its Python packages and dependencies from the operating system. This reduces dependency conflicts and makes the development environment easier to reproduce for other team members.

---

**4. Why must SSH private keys and `.venv/` remain outside version control?**

SSH private keys must remain outside version control because exposing them could allow unauthorized access to systems. The .venv/ directory should also remain outside Git because it contains machine-specific installed dependencies and can be recreated from requirements.txt.

The assignment explicitly prohibits exposing SSH private keys, passwords, tokens, API keys, credentials, and private certificates.
...
- [-] Task 7: `pre-commit run --all-files` comletes successfully
