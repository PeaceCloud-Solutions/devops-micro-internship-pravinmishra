...
![Task 1.A](<screenshots/week 04-assignment 02-screenshot 1.png>).

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![Task 1.B](<screenshots/week 04-assignment 02-screenshot 2.png>).
...
![Task 2](<screenshots/week 04-assignment 02-screenshot 3.png>).
...
![Task 3](<screenshots/week 04-assignment 02-screenshot 4.png>).
...
![Task 4.A](<screenshots/week 04-assignment 02-screenshot 5.png>).

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![Task 4.B](<screenshots/week 04-assignment 02-screenshot 6.png>).
...
![Task 5.A](<screenshots/week 04-assignment 02-screenshot 7.png>).

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![Task 5.B](<screenshots/week 04-assignment 02-screenshot 8.png>).
...
![Task 6.A](<screenshots/week 04-assignment 02-screenshot 9-1.png>).

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![Task 6.B](<screenshots/week 04-assignment 02-screenshot 10.png>).

---

#### Screenshot 11 — Output of `git commit`

![Task 6.C](<screenshots/week 04-assignment 02-screenshot 11.png>).

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![Task 6.D](<screenshots/week 04-assignment 02-screenshot 12.png>).
...
![Task 7 A](<screenshots/week 04-assignment 02-screenshot 13.png>).

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![Task 7.B](<screenshots/week 04-assignment 02-screenshot 14.png>).

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![Task 7.C](<screenshots/week 04-assignment 02-screenshot 15.png>).
...
`https://www.linkedin.com/posts/peace-offor-aa736a147_dmibypravinmishra-devops-git-share-7485650849378045952-PmEi/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACN4g58BM2OoiPOU_M6YmR_9gplw4hlL_RQ`

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![Linkedin post](<screenshots/week 04-assignment 02-screenshot 16.png>).
