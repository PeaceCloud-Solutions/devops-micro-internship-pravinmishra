...
![Task 1](<screenshots/week 07-assignment 07-screenshot 1.png>).
...
![Task 2](<screenshots/week 07-assignment 07-screenshot 2.png>).
...
![Task 3](<screenshots/week 07-assignment 07-screenshot 3.A.png>).
![Task 3](<screenshots/week 07-assignment 07-screenshot 3.B.png>)
![Task 3](<screenshots/week 07-assignment 07-screenshot 3.C.png>)
...
![Task 4.A](<screenshots/week 07-assignment 07-screenshot 4.A.png>).
![Task 4.A](<screenshots/week 07-assignment 07-screenshot 4.B.png>)
![Task 4.A](<screenshots/week 07-assignment 07-screenshot 4.C.png>)

---

#### Screenshot 5 — Output of `bash -n` (no syntax errors) and `ls -l` showing the script is executable

![Task 4.B](<screenshots/week 07-assignment 07-screenshot 5.png>).
...
![Task 5](<screenshots/week 07-assignment 07-screenshot 6.png>).
...
![Task 6.A](<screenshots/week 07-assignment 07-screenshot 7.png>).

---

#### Screenshot 8 — `/azure-audit` output showing the baseline findings and Claude's explanation

![Task 6.B](<screenshots/week 07-assignment 07-screenshot 8.A.png>).
![Task 6.B](<screenshots/week 07-assignment 07-screenshot 8.B.png>).
...
![Task 7.A](<screenshots/week 07-assignment 07-screenshot 9.png>).
...
![Task 7.B](<screenshots/week 07-assignment 07-screenshot 10.A.png>).
![Task 7.B](<screenshots/week 07-assignment 07-screenshot 10.B.png>).

---

#### Screenshot 11 — Second `/azure-audit` run (or report) showing the finding resolved

![Task 7.C](<screenshots/week 07-assignment 07-screenshot 11.A.png>).
![Task 7.C](<screenshots/week 07-assignment 07-screenshot 11.B.png>).
...
The Azure and AWS security audits evaluate similar security categories using different cloud-specific services and CLI commands. Azure Network Security Groups are comparable to AWS Security Groups, Azure Storage Account public-access controls correspond to Amazon S3 public-access controls, Azure VM disk-encryption settings correspond to EC2/EBS encryption, and Azure Database for MySQL network exposure is comparable to Amazon RDS public accessibility and security-group controls.

The workflow is consistent across both cloud platforms: gather read-only evidence first, classify findings as PASS, WARN, or FAIL, use AI to explain the evidence and recommend remediation without executing it, have the human operator review and perform the change, and then rerun the audit to verify that the issue was resolved. This demonstrates that the security-audit methodology is cloud-agnostic even though Azure uses az commands while AWS uses aws commands.
