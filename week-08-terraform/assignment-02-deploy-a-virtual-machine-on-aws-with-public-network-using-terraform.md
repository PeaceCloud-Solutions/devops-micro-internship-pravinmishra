...
![Task 0](<screenshots/week 08-assignment 02-screenshot 1.png>).
...
![Task 1.A](<screenshots/week 08-assignment 02-screenshot 2.png>).
...
![Task 1.B](<screenshots/week 08-assignment 02-screenshot 3.png>).
...
![Task 2](<screenshots/week 08-assignment 02-screenshot 4.png>).
...
![Task 3.A](<screenshots/week 08-assignment 02-screenshot 5.png>).

---

#### Screenshot 6 — Terraform apply output showing successful completion

![Task 3.B](<screenshots/week 08-assignment 02-screenshot 6.png>).

---

#### Screenshot 7 — Terraform output showing the public IP address of the EC2 instance

![Task 3.C](<screenshots/week 08-assignment 02-screenshot 7.png>).
...
**EC2 Public IP Address:** `16.170.246.189`
...
![Task 4.A](<screenshots/week 08-assignment 02-screenshot 8.png>).

---

#### Screenshot 9 — Browser showing the Nginx page successfully loaded using the EC2 instance public IP

![Task 4.B](<screenshots/week 08-assignment 02-screenshot 9.png>).
...
![Task 5](<screenshots/week 08-assignment 02-screenshot 10.png>).
